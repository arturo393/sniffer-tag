...
uint8_t tag_initiator_init(dwt_config_t *dwt_config,
		dwt_txconfig_t *dwt_txconfig, dwt_local_data_t *dwt_local_data) {
...
uint8_t send_message_with_timestamps(uint8_t*tx_final_msg,uint8_t size,uint8_t frame_seq_nb) {
